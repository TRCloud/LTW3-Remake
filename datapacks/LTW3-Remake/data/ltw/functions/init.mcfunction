...
# 记分板
scoreboard objectives remove fireball_countdown
scoreboard objectives add fireball_countdown dummy "火球倒计时"
scoreboard players add @a fireball_countdown 0
...
scoreboard players add @a tnt_countdown 0
...
scoreboard objectives remove effect_jump_boost
scoreboard objectives add effect_jump_boost dummy "跳跃计时"
scoreboard objectives remove effect_regeneration
scoreboard objectives add effect_regeneration dummy "回血计时"
scoreboard objectives remove effect_slowing
scoreboard objectives add effect_slowing dummy "减慢计时"
scoreboard objectives remove effect_speed
scoreboard objectives add effect_speed dummy "加速计时"
...
team add slime_lock "足球锁死颜色"
team modify slime_lock color red
