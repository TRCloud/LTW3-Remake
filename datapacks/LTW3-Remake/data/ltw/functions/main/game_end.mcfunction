...
# 安慰奖
execute as @a[tag=total_rankl] run scoreboard players add @s gold 6
execute as @a[tag=total_rankl] run scoreboard players add @s gold_total 6
tellraw @a[tag=total_rankl] [" 不要气馁，收下 ",{"text": "6 金粒","color":"gold"}," 奖励，继续加油吧！"]
