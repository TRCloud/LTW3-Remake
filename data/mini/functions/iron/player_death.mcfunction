...
execute if score #iron_block_count temp matches 3.. at @e[type=armor_stand,tag=dead_marker,limit=1] run summon item ~0.1 ~0.2 ~0.1 {Tags:["temp_iron_block"],Item:{id:"minecraft:iron_block",Count:1b}}
...
execute if score #iron_nugget_count temp matches 3.. at @e[type=armor_stand,tag=dead_marker,limit=1] run summon item ~-0.1 ~0.2 ~0.1 {Tags:["temp_iron_nugget"],Item:{id:"minecraft:iron_nugget",Count:1b}}
...
execute if score #raw_iron_block_count temp matches 3.. at @e[type=armor_stand,tag=dead_marker,limit=1] run summon item ~-0.1 ~0.2 ~0.1 {Tags:["temp_raw_iron_block"],Item:{id:"minecraft:raw_iron_block",Count:1b}}
