...
execute if score $mini_type mem matches 202 run function mini:slime/player_intro
execute if score $mini_type mem matches 103 run function mini:flag/player_intro