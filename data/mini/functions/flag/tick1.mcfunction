...
# 旗帜加分
execute as @a[nbt={Inventory:[{Slot:8b,id:"minecraft:white_banner",tag:{display:{Name:'{"text":"Debug_Banner"}'}}}]},tag=flag_holding] at @s if block ~ ~-1 ~ minecraft:bedrock run function mini:flag/game/flag_add_score