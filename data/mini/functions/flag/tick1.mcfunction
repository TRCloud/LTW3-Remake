...
execute as @a[nbt={SelectedItem:{id:"minecraft:fire_charge"}}] at @s if score @s fireball_countdown matches 1..100 run title @s actionbar [{"text":"冷却:","color": "aqua"},{"score": {"name": "@s","objective": "fireball_countdown"},"color": "aqua"},{"text": "/0","color": "white"}]
