...
# 20 / 5% 大成功：获得 1 金块
execute unless score @s gold matches 648.. run execute if score $random mem matches 20 run function ltw:state/0/roll_dice/super_win

# 防止过于破解版
execute unless score @s gold matches 405.. run execute if score $random mem matches 20 run function ltw:state/0/roll_dice/super_win
execute if score @s gold matches 405.. run function ltw:state/0/roll_dice/super_lose
