...
tellraw @a[team=!watching,team=!playing,team=!debugging] ["",{"text":">> ","bold":true,"color":"aqua"},"如果你想要观战当前战局, 请点击 [",{"text":"这里","bold":true,"underlined":true,"color":"green","clickEvent":{"action":"run_command","value":"/trigger switch_trigger"}},"] 以切换模式"]
